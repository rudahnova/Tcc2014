...
public class Jogar extends ActionBarActivity implements ISaveScore{
    ...
    public void onResult(boolean ok, String msg) {
        Util.createAlert(null,msg, this).setPositiveButton("Ok", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                Jogar.this.finish();
            }
